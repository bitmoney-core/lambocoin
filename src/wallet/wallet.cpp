        ...
        LOCK2(cs_main, cs_wallet);
        {
            ...
            while (true)
            {
                ...
                *static_cast<CTransaction*>(&wtxNew) = CTransaction(txNew);
                ...
                // Lambocoin: Disable free transactions
...
{
    // Lambocoin: Round TX bytes up to the next 1,000 bytes
    ...
    if (nFeeNeeded == 0) {
        ...
        // Lambocoin: Add an increased fee for each dust output
        nFeeNeeded += GetLambocoinDustFee(tx.vout, minTxFee);
    }
