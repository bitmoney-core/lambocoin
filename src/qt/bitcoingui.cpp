    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Lambocoin Core") + " - ";
#ifdef ENABLE_WALLET
    ...
    // Lambocoin: Specify Comic Sans as new font.
    QFont newFont("Calibri", 10);

    // Lambocoin: Set new application font
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Lambocoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and lambocoin: URIs)"));
    ...
    aboutAction = new QAction(platformStyle->TextColorIcon(":/icons/about"), tr("&About Lambocoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about Lambocoin Core"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(platformStyle->TextColorIcon(":/icons/about_qt"), tr("About &Qt"), this);
    aboutQtAction->setStatusTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(platformStyle->TextColorIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setStatusTip(tr("Modify configuration options for Lambocoin Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Lambocoin addresses to prove you own them"));
    verifyMessageAction = new QAction(platformStyle->TextColorIcon(":/icons/verify"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Lambocoin addresses"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the Lambocoin Core help message to get a list with possible Lambocoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Lambocoin Core client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("Lambocoin"); // default title
