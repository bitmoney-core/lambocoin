    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Lambocoin Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (about)
    {
        setWindowTitle(tr("About Lambocoin Core"));
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Lambocoin Core is shutting down...") + "<br /><br />" +
