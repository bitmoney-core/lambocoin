...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Lambocoin Core lambocoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  lambocoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded lambocoin transaction") + "\n" +
              "  lambocoin-tx [options] -create [commands]   " + _("Create hex-encoded lambocoin transaction") + "\n" +
              "\n";
