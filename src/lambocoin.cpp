// Copyright (c) 2015 The Lambocoin Core developers
...
// Lambocoin: Normally minimum difficulty blocks can only occur in between
...
unsigned int CalculateLambocoinNextWorkRequired(const CBlockIndex* pindexLast, int64_t nFirstBlockTime, const Consensus::Params& params)
{
...
CAmount GetLambocoinBlockSubsidy(int nHeight, const Consensus::Params& consensusParams, uint256 prevHash)
{
    ...
    if (!consensusParams.fSimplifiedRewards)
    {
        ...
        CAmount maxReward = (10000 >> halvings) - 1;
...
int64_t GetLambocoinDustFee(const std::vector<CTxOut> &vout, CFeeRate &baseFeeRate) {
    int64_t nFee = 0;
